...
# the brick function imports the files into R
...
plotRGB(l2011, r=4, g=3, b=2, stretch="Lin") #the nir is now red and is the best solution in which plants absorb the blue and red, reflect green and the nir. 
plotRGB(l2011, r=4, g=3, b=2, stretch="Hist") #histogram stretching that enounce the stream 

#now we import the data of 1988 with brick function
l1988 <- brick("p224r63_1988.grd")
l1988 # always with 7 bands, the same resolution of l2011
# plot together the 2 images with the par function 
par(mfrow=c(2,1)) #2 rows and 1 column where the first row is the 1988 image, the second is the 2011 image 
plotRGB(l1988, r=4, g=3, b=2, stretch="Lin")
plotRGB(l2011, r=4, g=3, b=2, stretch="Lin")

# Put the nir in the blue channel to enounce the agricultural area 
par(mfrow=c(2,1))
